...
if __name__ == "__main__":
    ...
    while True:
        ...
        if Robot.mission == FIND_BALL:
            ...
            Robot.bool_shot_zone, frame = Camera.analyze_short_path_r(img)
            shot_roi = True
            ...
            if shot_count == 0:
                Robot.bool_shot_zone, frame, shot_power = Camera.analyze_long_path_gamble(img)
            elif shot_count == 1:
                Robot.bool_shot_zone, frame, shot_power = Camera.analyze_long_path_r(img)
            else:
